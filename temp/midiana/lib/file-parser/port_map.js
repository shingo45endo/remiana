export function makePortMap(song) {
	...
	if (keys.includes('yamahaPortPrefix')) {
		...
		// As for the internal representation of Recomposer channel No., originally, 1-16 are used for MPU-401 and 17-32 are used for RS-MIDI.
		// After Recomposer supports Super MPU, a multi-port MIDI interface, channel No. 1-16 are used for Port-A and 17-32 are used for Port-B.
